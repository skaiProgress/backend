...
// Create handles POST /functions/v1/lessons.
...
// Update handles PATCH /functions/v1/lessons/:id.
...
func mapError(c echo.Context, err error) error {
	...
	default:
		msg := err.Error()
		if msg == "invalid youtube url" ||
			msg == "course_id, title and youtube_url are required" ||
			msg == "title cannot be empty" ||
			msg == "course_id is required" ||
			msg == "course_id and ordered_ids are required" {
